        ...
        <header id="header">
            ...
            <nav class="navbar navbar-default">
                ...
                <div class="dropdown">
                    ...
                    <li role="presentation"><a href="articles.php?area=2" role="menuitem" tabindex="-1" onclick="changeField('前端')">前端</a></li>
                    <li role="presentation"><a href="articles.php?area=3" role="menuitem" tabindex="-1" onclick="changeField('后端')">后端</a></li>
                    <li role="presentation"><a href="articles.php?area=4" role="menuitem" tabindex="-1" onclick="changeField('移动端')">移动端</a></li>
                    <li role="presentation"><a href="articles.php?area=5" role="menuitem" tabindex="-1" onclick="changeField('浏览器')">浏览器</a></li>
                    <li role="presentation"><a href="articles.php?area=6" role="menuitem" tabindex="-1" onclick="changeField('应用软件')">应用软件</a></li>
