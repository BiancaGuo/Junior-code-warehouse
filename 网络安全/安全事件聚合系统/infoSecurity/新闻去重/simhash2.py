...
class TextSimilarity(object):
    def __init__(self, str_a,str_b):
        ...
        初始化类行
        '''
        self.str_a = str_a.replace(' ', '').replace('\n', '').replace('\t', '')
        self.str_b = str_b.replace(' ', '').replace('\n', '').replace('\t', '')
...
if __name__ == '__main__':
    s1="""
    景驰科技CEO王劲在签约活动上表示，公司核心团队将从美国硅谷迁至黄埔区广州开发区，建立国内首个无人车大规模产业化公司。

“我们非常兴奋，也非常期待。祖国，我们回来了。”王劲说到。签约现场，景驰科技首席技术官韩旭和技术副总裁杨庆雄乘坐两辆带有“JingChi”logo的无人驾驶车从峻祥路驶入，沿会场右侧的道路下坡、转弯。

广州市黄浦区开发区与景驰科技的合作将在以下几个方面：

1、景驰科技将全球总部落户黄埔区广州开发区。包括研发总部、运营总部和销售总部在内的核心团队将从美国硅谷迁至黄埔区广州开发区，建国内首个无人车大规模产业化公司，打造世界顶级的无人驾驶技术；

2、景驰科技将在广州市开发区内进行常态化运营，打造国内首个无人车常态化商业运营示范点；

3、从2018年第一季度起，全年将量产500-1000辆无人驾驶车

4、打造广州人工智能高地，景驰科技参与并建设世界一流的人工智能研究院和人工智能学堂；

5、三年内，景驰科技将引进和培养1000人，其中包括百名高端人才；

6、景驰科技与黄埔区广州开发区、广州开发区金融控股集团和知名基金将围绕景驰科技共同打造100亿元的产业基金，布局无人驾驶上下游产业，合力打造智能驾驶、智能制造和智慧出行，共塑新型智能出行生态。
"""
    s2="""

"""
    a = TextSimilarity(s1,s2)
    print a.minimumEditDistance(a.str_a, a.str_b)
    print a.JaccardSim(a.str_a, a.str_b)
    print a.splitWordSimlaryty(a.str_a, a.str_b, sim=a.pers_sim)