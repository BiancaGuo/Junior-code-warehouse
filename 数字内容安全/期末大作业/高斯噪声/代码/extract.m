...
%% 水印提取(原图高斯噪声 and 嵌入水印后图片的高斯噪声）

for i=0.01:0.01:0.5
    path='..\';
    pending_file_name=strcat(path,'lena_高斯噪声_',num2str(i),'.bmp');
    ...
    watermark_file = fopen(strcat(path_watermark,'lena_高斯噪声_',num2str(i),'.txt'),'wt');%数据保存在你当前的文件夹下，文件名为Data.txt
